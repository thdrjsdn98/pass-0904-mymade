var currentSubPage = 0;
        ...
        // ============================================================
        // 🖊️ 본문 S펜 필기: 3색 볼펜 + 3색 고발색 맑은 투명 형광펜 + 지우개
        // ============================================================
        function createPenCanvasForPage(page) {
            ...
            // 🌟 선 다시 그리기: 앱 재실행 복원 시에도 옅어지지 않는 형광 농도(0.78) 유지
            function redrawAll() {
            ...
            var currentTool = 'pen';
            var penColor = '#2563eb';
            var highlighterColor = 'rgba(250, 204, 21, 0.78)'; // 형광 노랑
            ...
            var highColors = [
                { color: 'rgba(250, 204, 21, 0.78)', bg: '#facc15' }, // 형광 노랑
                { color: 'rgba(74, 222, 128, 0.75)', bg: '#4ade80' }, // 형광 초록
                { color: 'rgba(244, 114, 182, 0.75)', bg: '#f472b6' }  // 형광 분홍
            ];
