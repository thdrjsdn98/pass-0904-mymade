var currentSubPage = 0;
        ...
        // ============================================================
        // 🖊️ 본문 S펜 필기: 3색 볼펜 + 3색 맑은 투명 형광펜 + 지우개
        // ============================================================
        function createPenCanvasForPage(page) {
            ...
            // 🌟 선 다시 그리기: CSS 블렌드 모드와 연동되어 타지 않고 맑게 복원
            function redrawAll() {
            ...
            var currentTool = 'pen';
            var penColor = '#2563eb';
            var highlighterColor = 'rgba(250, 204, 21, 0.45)'; // 맑은 형광 노랑
            ...
            var highColors = [
                { color: 'rgba(250, 204, 21, 0.45)', bg: '#facc15' }, // 형광 노랑
                { color: 'rgba(74, 222, 128, 0.45)', bg: '#4ade80' }, // 형광 초록
                { color: 'rgba(244, 114, 182, 0.45)', bg: '#f472b6' }  // 형광 분홍
            ];
            ...
            wrap.addEventListener('pointerdown', function(e) {
                ...
                // 캔버스 자체 내부 연산은 모두 source-over로 통일하여 탄 색상 방지
